...
class SaleOrder(models.Model):
    ...
    website_description_footer = fields.Html(
        'Website Description Footer', sanitize_attributes=False, translate=html_translate)
    header_template_description = fields.Html(
        'Website Description Dynamical Header', sanitize_attributes=False, translate=html_translate, default="<p></p>")
    footer_template_description = fields.Html(
        'Website Description Dynamical Footer', sanitize_attributes=False, translate=html_translate, default="<p></p>")
